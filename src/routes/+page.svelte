		...
		<div class="flex min-h-[calc(100vh-68px)] items-center justify-center py-20 lg:py-28">
			<div class="flex w-full max-w-[900px] flex-col items-center text-center">
				...
				<div class="mt-9">
					<a
						href="/event"
						class="group relative inline-flex h-14 items-center justify-center gap-3 overflow-hidden rounded-full bg-gradient-to-br from-violet-500 via-violet-600 to-violet-800 px-10 text-base font-bold uppercase tracking-widest text-white shadow-[0_0_40px_rgba(168,85,247,0.55),0_0_80px_rgba(168,85,247,0.2)] transition duration-300 hover:scale-[1.04] hover:shadow-[0_0_60px_rgba(168,85,247,0.75),0_0_120px_rgba(168,85,247,0.3)]"
